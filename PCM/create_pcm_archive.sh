...
# script taken from https://github.com/ebastler/marbastlib/blob/main/PCM/create_pcm_archive.sh
...
echo DOWNLOAD_URL="https:\/\/github.com\/qmk-arterytek\/arterytek_kicad_library\/releases\/download\/$VERSION\/KiCAD-PCM-$VERSION.zip" >> $GITHUB_ENV
